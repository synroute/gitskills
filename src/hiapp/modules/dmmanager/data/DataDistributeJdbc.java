...
public class DataDistributeJdbc extends BaseRepository {
    ...
    public Map<String, Object> saveDistributeDataToDB(Integer bizId, String userId, String disName, String description, String tempIds, List<Map<String, Object>> dataPoolList) {
        Connection conn = null;
        PreparedStatement pst = null;
        ...
        String tempTableName = "HAU_DM_" + bizId + "_" + userId;
        Map<String, Object> resultMap = new HashMap<String, Object>();
        //根据临时表的数据存到redis中，在存储过程调用之后，该数据会被删除
        manualModeDAO.getManualDistributeCustomers(bizId, disBatchId, tempIds, tempTableName);
        try {

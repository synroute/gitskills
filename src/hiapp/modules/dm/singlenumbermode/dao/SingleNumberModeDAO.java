...
public class SingleNumberModeDAO extends BaseRepository {
    ...
    public Boolean getGivenBizShareDataItemsByState(int bizId, List<ShareBatchItem> ShareBatchItems,
        ...
        try {
            ...
            while (rs.next()) {
                ...
                item.setLastDialTime(rs.getDate(14));
                item.setNextDialTime(rs.getDate(15));
                item.setLostCallCurDayCount(rs.getInt(16));
                item.setCurRedialStageCount(rs.getInt(17));
                item.setUserUseState(rs.getString(18));
                item.setLostCallFirstDay(rs.getDate(19));
                item.setLostCallCurDay(rs.getDate(20));
    ...
    public Boolean updateCustomerShareState(int bizId, HashSet<String> shareBatchIdSet,
                                            SingleNumberModeShareCustomerStateEnum originalState,
                                            SingleNumberModeShareCustomerStateEnum newState) {

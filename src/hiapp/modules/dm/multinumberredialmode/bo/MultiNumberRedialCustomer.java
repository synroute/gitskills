...
public class MultiNumberRedialCustomer implements Serializable{
    ...
    public MultiNumberRedialStateEnum getState() {
        return state;
    }

    public void setState(MultiNumberRedialStateEnum state) {
        this.state = state;
    }

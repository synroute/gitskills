...
/**
 * Servlet implementation class ServletDMBusinessGetAll
 */
@WebServlet("/ServletDMBusinessGetAll")
public class ServletDMBusinessGetAll extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletDMBusinessGetAll() {
        super();

...
/**
 * Servlet implementation class ServletDMWorkSheetColumnsGetAll
 */
@WebServlet("/ServletDMWorkSheetColumnsGetAll")
public class ServletDMWorkSheetColumnsGetAll extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletDMWorkSheetColumnsGetAll() {
        super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			WorkSheet.getColumns(dbConn, Integer.parseInt(workSheetId), listColumns);
			...
			recordsetResult.setTotal(listColumns.size());
			recordsetResult.setPageSize(listColumns.size());
			recordsetResult.setRows(listColumns);

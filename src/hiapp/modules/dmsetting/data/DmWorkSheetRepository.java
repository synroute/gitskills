...
public class DmWorkSheetRepository extends BaseRepository {
	...
	//数据池操作记录表
		...
		private ServiceResultCode m_newWorkSheetDuoDataM3(Connection dbConn,DMBusiness dmBusiness,StringBuffer errMessage){
			...
			creationInfoWorkSheet.addColumn("电话类型1_产生预约拨打次数", "PT1_CAUSEPRESETDIALCOUNT", "电话类型1_产生预约拨打次数", WorkSheetDataType.TEXT, 50, false, true);
			...
			creationInfoWorkSheet.addColumn("电话类型2_产生预约拨打次数", "PT2_CAUSEPRESETDIALCOUNT", "电话类型2_产生预约拨打次数", WorkSheetDataType.TEXT, 50, false, true);
			...
			creationInfoWorkSheet.addColumn("电话类型3_产生预约拨打次数", "PT3_CAUSEPRESETDIALCOUNT", "电话类型3_产生预约拨打次数", WorkSheetDataType.TEXT, 50, false, true);
			...
			creationInfoWorkSheet.addColumn("电话类型4_产生预约拨打次数", "PT4_CAUSEPRESETDIALCOUNT", "电话类型4_产生预约拨打次数", WorkSheetDataType.TEXT, 50, false, true);
			...
			creationInfoWorkSheet.addColumn("电话类型5_产生预约拨打次数", "PT5_CAUSEPRESETDIALCOUNT", "电话类型5_产生预约拨打次数", WorkSheetDataType.TEXT, 50, false, true);
			...
			creationInfoWorkSheet.addColumn("电话类型6_产生预约拨打次数", "PT6_CAUSEPRESETDIALCOUNT", "电话类型6_产生预约拨打次数", WorkSheetDataType.TEXT, 50, false, true);
			...
			creationInfoWorkSheet.addColumn("电话类型7_产生预约拨打次数", "PT7_CAUSEPRESETDIALCOUNT", "电话类型7_产生预约拨打次数", WorkSheetDataType.TEXT, 50, false, true);
			...
			creationInfoWorkSheet.addColumn("电话类型8_产生预约拨打次数", "PT8_CAUSEPRESETDIALCOUNT", "电话类型8_产生预约拨打次数", WorkSheetDataType.TEXT, 50, false, true);
			...
			creationInfoWorkSheet.addColumn("电话类型9_产生预约拨打次数", "PT9_CAUSEPRESETDIALCOUNT", "电话类型9_产生预约拨打次数", WorkSheetDataType.TEXT, 50, false, true);
			...
			creationInfoWorkSheet.addColumn("电话类型10_产生预约拨打次数", "PT10_CAUSEPRESETDIALCOUNT", "电话类型10_产生预约拨打次数", WorkSheetDataType.TEXT, 50, false, true);
